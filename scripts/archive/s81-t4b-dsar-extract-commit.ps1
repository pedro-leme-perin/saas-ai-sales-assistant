...
$logFile = "$repo\scripts\s81-t4b-dsar-extract-commit.log"
$msgFile = "$repo\scripts\s81-t4b-dsar-extract-commit-msg.txt"
...
Log "=== S81-T4b dsar-extract.service.spec commit ==="
Log "repo: $repo"
...
Run-Git -gitArgs 'add apps/backend/test/unit/dsar-extract.service.spec.ts'
