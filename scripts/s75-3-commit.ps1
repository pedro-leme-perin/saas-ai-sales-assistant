...
$LogFile = "scripts\s75-3-commit.log"
"=== S75-3 commit start: $(Get-Date) ===" | Tee-Object -FilePath $LogFile
...
Remove-Item -Force .git\index.lock -ErrorAction SilentlyContinue
git add apps/frontend/package.json pnpm-lock.yaml CHANGELOG.md PROJECT_HISTORY.md CLAUDE.md scripts/s75-3-commit.ps1 scripts/s75-3-commit.bat scripts/s75-3-commit-msg.txt 2>&1 | Tee-Object -FilePath $LogFile -Append

Write-Host "[4/5] git commit..."
git commit -F scripts\s75-3-commit-msg.txt 2>&1 | Tee-Object -FilePath $LogFile -Append
...
"=== S75-3 commit done: $(Get-Date) ===" | Tee-Object -FilePath $LogFile -Append
Write-Host "DONE."
