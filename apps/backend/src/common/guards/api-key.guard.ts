...
export class ApiKeyGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    (request as Record<string, unknown>)['apiKeyCompanyId'] = storedKey.companyId;
    (request as Record<string, unknown>)['apiKeyScopes'] = storedKey.scopes;
    (request as Record<string, unknown>)['apiKeyName'] = storedKey.name;
